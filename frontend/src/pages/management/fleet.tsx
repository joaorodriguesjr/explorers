...
const NewFleet: NextPage = () => {
  const { game, account, calculateRank, createFleet } = useGame()
  ...
  const handleActionClick = () => {
    createFleet(selected.spaceships, selected.workers)
  ...
  return (
    <PageContainer>
      ...
      <Padding vertical={false} grow={true}>
        <Heading size={1}>New Fleet</Heading>
        ...
        <Tabs labels={['Available', 'Selected']}>
